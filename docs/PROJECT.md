...
| `npm run smoke` | 386 end-to-end checks against a live, freshly seeded server |
| `npm run smoke:ui` | 99 checks that load every admin screen in a real browser |
...
| `npm run smoke` | **386 checks, 0 failures** — see [TESTING.md](./TESTING.md) |
| `npm run smoke:ui` | **99 checks, 0 failures** — every admin screen, in Chrome |
